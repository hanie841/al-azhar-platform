...
class EventSeeder extends Seeder
{
    public function run(): void
    {
        $events = [
            ...
            [
                'slug' => 'ramadan-taraweeh-program-2026',
                'title' => [
                    'ar' => 'برنامج تراويح رمضان 2026',
                    'en' => 'Ramadan Taraweeh Program 2026',
                    'fr' => 'Programme des Taraweeh du Ramadan 2026',
                    'es' => 'Programa de Taraweeh del Ramadan 2026',
                    'zh' => '2026年斋月泰拉威祈祷项目',
                    'ru' => 'Программа Таравих Рамадана 2026',
                    'ur' => 'رمضان تراویح پروگرام 2026',
                ],
                'description' => [
                    'ar' => 'يقام برنامج صلاة التراويح في الجامع الأزهر الشريف طوال شهر رمضان المبارك 1447هـ/2026م. يؤم الصلاة قراء بارزون من الأزهر الشريف في أجواء روحانية فريدة بالمسجد التاريخي الذي يعود تاريخه لأكثر من ألف عام.',
                    'en' => 'Nightly Taraweeh prayers led by renowned Al-Azhar reciters at the historic Al-Azhar Mosque throughout Ramadan 1447 AH/2026. The program offers a unique spiritual experience at the over-thousand-year-old mosque.',
                    'fr' => 'Prieres de Taraweeh nocturnes dirigees par des recitateurs renommes d\'Al-Azhar a la mosquee historique pendant tout le Ramadan 2026.',
                    'es' => 'Oraciones nocturnas de Taraweeh dirigidas por renombrados recitadores de Al-Azhar en la historica mezquita durante todo el Ramadan 2026.',
                    'zh' => '2026年斋月期间，著名的艾资哈尔诵经师每晚在历史悠久的艾资哈尔清真寺带领泰拉威祈祷。',
                    'ru' => 'Ежевечерние молитвы Таравих под руководством известных чтецов Аль-Азхара в исторической мечети в течение всего Рамадана 2026.',
                    'ur' => 'رمضان 2026 کے دوران تاریخی جامع الازہر میں ممتاز الازہر قاریوں کی امامت میں ہر رات تراویح کی نماز۔',
                ],
                'location' => [
                    'ar' => 'الجامع الأزهر الشريف - القاهرة',
                    'en' => 'Al-Azhar Mosque - Cairo',
            ...
            [
                'slug' => 'international-day-human-fraternity-2026',
                'title' => [
                    'ar' => 'اليوم الدولي للأخوة الإنسانية',
                    'en' => 'International Day of Human Fraternity',
                    'fr' => 'Journee internationale de la Fraternite Humaine',
                    'es' => 'Dia Internacional de la Fraternidad Humana',
                    'zh' => '国际人类博爱日',
                    'ru' => 'Международный день человеческого братства',
                    'ur' => 'بین الاقوامی یوم انسانی اخوت',
                ],
                'description' => [
                    'ar' => 'إحياء اليوم الدولي للأخوة الإنسانية الذي أعلنته الأمم المتحدة في 4 فبراير تقديراً لوثيقة الأخوة الإنسانية التاريخية الموقعة من الإمام الأكبر والبابا فرنسيس في أبوظبي. تُقام فعاليات افتراضية وحضورية للاحتفال بهذه المناسبة.',
                    'en' => 'Commemorating the International Day of Human Fraternity declared by the UN on February 4, honoring the historic Document on Human Fraternity signed by the Grand Imam and Pope Francis in Abu Dhabi. Virtual and in-person events celebrate this occasion.',
                    'fr' => 'Commemoration de la Journee internationale declaree par l\'ONU le 4 fevrier, honorant le Document historique sur la Fraternite Humaine signe a Abu Dhabi.',
                    'es' => 'Conmemoracion del Dia Internacional declarado por la ONU el 4 de febrero, honrando el Documento historico sobre la Fraternidad Humana firmado en Abu Dabi.',
                    'zh' => '纪念联合国宣布的2月4日国际人类博爱日，致敬大伊玛目和教皇方济各在阿布扎比签署的历史性文件。',
                    'ru' => 'Празднование Международного дня, объявленного ООН 4 февраля в честь исторического Документа о братстве, подписанного в Абу-Даби.',
                    'ur' => 'اقوام متحدہ کے 4 فروری کو اعلان کردہ بین الاقوامی یوم انسانی اخوت کی یاد، ابوظبی میں دستخط شدہ تاریخی دستاویز کی تکریم۔',
                ],
                'location' => [
                    'ar' => 'افتراضي / أبوظبي',
                    'en' => 'Virtual / Abu Dhabi',
                    'fr' => 'Virtuel / Abu Dhabi',
                    'es' => 'Virtual / Abu Dabi',
                    'zh' => '线上 / 阿布扎比',
                    'ru' => 'Виртуальный / Абу-Даби',
                    'ur' => 'آن لائن / ابوظبی',
                ],
            ...
            [
                'slug' => 'academic-year-opening-ceremony-2026-2027',
                'title' => [
                    'ar' => 'حفل افتتاح العام الدراسي 2026-2027',
                    'en' => 'Academic Year Opening Ceremony 2026-2027',
                    'fr' => 'Ceremonie d\'ouverture de l\'annee academique 2026-2027',
                    'es' => 'Ceremonia de apertura del ano academico 2026-2027',
                    'zh' => '2026-2027学年开学典礼',
                    'ru' => 'Церемония открытия учебного года 2026-2027',
                    'ur' => 'تعلیمی سال 2026-2027 کی افتتاحی تقریب',
                ],
                'description' => [
                    'ar' => 'تقيم جامعة الأزهر حفل افتتاح العام الدراسي الجديد 2026-2027 بالحرم الجامعي الرئيسي بالقاهرة. يُتوقع تسجيل أكثر من 15,000 طالب جديد. يتضمن الحفل كلمات ترحيبية وتعريف بالكليات والبرامج الأكاديمية الجديدة.',
                    'en' => 'Al-Azhar University holds the opening ceremony for the 2026-2027 academic year at the main campus in Cairo. Over 15,000 new students are expected to register. The ceremony includes welcome addresses and introduction to faculties and new academic programs.',
                    'fr' => 'L\'Universite d\'Al-Azhar organise la ceremonie d\'ouverture au campus principal du Caire. Plus de 15 000 nouveaux etudiants sont attendus.',
                    'es' => 'La Universidad de Al-Azhar celebra la ceremonia de apertura en el campus principal de El Cairo. Se esperan mas de 15.000 nuevos estudiantes.',
                    'zh' => '艾资哈尔大学在开罗主校区举行新学年开学典礼，预计超过15,000名新生注册。',
                    'ru' => 'Университет Аль-Азхар проводит церемонию открытия учебного года в главном кампусе Каира. Ожидается более 15 000 новых студентов.',
                    'ur' => 'الازہر یونیورسٹی قاہرہ کے مرکزی کیمپس میں نئے تعلیمی سال کی افتتاحی تقریب منعقد کرتی ہے۔ 15,000 سے زائد نئے طلباء کے اندراج کی توقع ہے۔',
                ],
                'location' => [
                    'ar' => 'الحرم الجامعي الرئيسي - جامعة الأزهر - القاهرة',
                    'en' => 'Al-Azhar University Main Campus - Cairo',
                    'fr' => 'Campus principal - Universite d\'Al-Azhar - Le Caire',
                    'es' => 'Campus principal - Universidad de Al-Azhar - El Cairo',
                    'zh' => '艾资哈尔大学主校区 - 开罗',
                    'ru' => 'Главный кампус - Университет Аль-Азхар - Каир',
                    'ur' => 'مرکزی کیمپس - الازہر یونیورسٹی - قاہرہ',
                ],
            ...
            [
                'slug' => 'holy-quran-national-competition-2026',
                'title' => [
                    'ar' => 'مسابقة القرآن الكريم الوطنية 2026',
                    'en' => 'Holy Quran National Competition 2026',
                    'fr' => 'Concours national du Saint Coran 2026',
                    'es' => 'Competencia Nacional del Sagrado Coran 2026',
                    'zh' => '2026年全国古兰经竞赛',
                    'ru' => 'Национальный конкурс Священного Корана 2026',
                    'ur' => 'قومی مقابلہ قرآن مجید 2026',
                ],
                'description' => [
                    'ar' => 'تقيم جامعة الأزهر مسابقة القرآن الكريم الوطنية السنوية 2026 في الجامع الأزهر الشريف بالقاهرة. تشمل المسابقة فئات حفظ القرآن الكريم كاملاً وتجويده بين طلاب المعاهد الأزهرية من جميع أنحاء مصر. تستمر المسابقة من 15 إلى 20 أبريل.',
                    'en' => 'Al-Azhar holds the annual Holy Quran National Competition 2026 at Al-Azhar Mosque in Cairo. The competition includes categories for full Quran memorization and recitation among Azhari institute students from across Egypt, running from April 15 to 20.',
                    'fr' => 'Al-Azhar organise le concours national annuel du Saint Coran 2026 a la mosquee Al-Azhar, avec des categories de memorisation et de recitation pour les etudiants de tout le pays.',
                    'es' => 'Al-Azhar celebra el concurso nacional anual del Sagrado Coran 2026 en la mezquita de Al-Azhar, con categorias de memorizacion y recitacion para estudiantes de todo el pais.',
                    'zh' => '艾资哈尔在艾资哈尔清真寺举办2026年全国古兰经年度竞赛，设有全国各地艾资哈尔学院学生的背诵和诵读类别。',
                    'ru' => 'Аль-Азхар проводит ежегодный Национальный конкурс Корана 2026 в мечети Аль-Азхар с категориями заучивания и чтения для студентов со всей страны.',
                    'ur' => 'الازہر جامع الازہر میں 2026 کا سالانہ قومی مقابلہ قرآن مجید منعقد کرتا ہے، پورے ملک سے الازہر معاہد کے طلباء کے لیے حفظ اور تلاوت کے مقابلے شامل ہیں۔',
                ],
                'location' => [
                    'ar' => 'الجامع الأزهر الشريف - القاهرة',
                    'en' => 'Al-Azhar Mosque - Cairo',
