          ...
          {links.map((link, i) => {
            ...
            return (
              ...
              >
                <Link
                  href={link.href}
                  className="group block p-6 bg-sand-50 dark:bg-navy-900 rounded-2xl border border-sand-200 dark:border-navy-700 hover:border-accent-400 hover:shadow-lg hover:shadow-accent-100 transition-all duration-300 hover:-translate-y-1"
                >
                  ...
                  <h3 className="font-serif text-xl font-bold text-primary-900 dark:text-primary-200 mb-2">
                    {t(`${link.key}Title`)}
                  </h3>
